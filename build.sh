...
# Kernel Defconfig
DEFCONFIG=agni_lavender-MIUI-Q_defconfig
...
function cloneTC() {
	...
	then
	post_msg "|| Cloning Llvm Clang ToolChain ||"
	git clone --depth=1 https://github.com/sohamxda7/llvm-stable -b aosp-12.0.6 clang
	PATH="${KERNEL_DIR}/clang/bin:$PATH"
